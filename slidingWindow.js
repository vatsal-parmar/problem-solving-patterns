 ...
 * (and a new window created).
 * Very useful for keeping track of a subset of data in an array/string.
 */

/**
 * Ex. write a function called maxSubarraySum which accepts an array of
 * integers and a number called n. The function should calculate the maximum
...
function maxSubarraySum(arr = [], num = 0) {
  let maxSum = 0;
  let tempSum = 0;
